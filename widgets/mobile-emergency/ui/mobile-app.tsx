...
import { IncidentHistoryScreen } from '@/components/mobile/incident-history-screen'
import { IncidentTrackingScreen } from '@/components/mobile/incident-tracking-screen'
