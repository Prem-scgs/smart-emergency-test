...
test('gis page uses admin i18n and localized boundary names', () => {
  ...
  assert.match(page, /provinceDisplay\(province, preferThai\)/)
  assert.match(page, /districtDisplay\(area, preferThai\)/)
  assert.match(page, /areaLabel\(selectedArea, preferThai\)/)
