...
test('call logs print snapshot follows dark admin theme during print preview', () => {
  assert.match(page, /html\.dark \.print-only-call-logs/)
  assert.match(page, /color-scheme: dark/)
  assert.match(page, /background: #0a0a0a/)
  assert.match(page, /border-color: #404040 !important/)
})
