...
INSERT INTO contacts
  (id, name, phone, role, category, province, district, latitude, longitude, location, active, is_24_hours)
VALUES
  (
  ...
  (
    ...
    13.7501,
    100.5402,
    ST_SetSRID(ST_MakePoint(100.5402, 13.7501), 4326),
    true,
    true
  ),
  (
...
VALUES
  (
    ...
    856,
    4.2,
    '{"police":312,"medical":456,"fire":89,"rescue":67,"flood":45,"road-accident":178}'::jsonb,
    '{"Bangkok":456,"Chiang Mai":123,"Phuket":89,"Chonburi":156,"Khon Kaen":78,"Songkhla":67,"Nakhon Ratchasima":89,"Other":189}'::jsonb,
    94.5
  )
ON CONFLICT (id) DO UPDATE
SET
  ...
  total_agencies = EXCLUDED.total_agencies,
  avg_response_time = EXCLUDED.avg_response_time,
  calls_by_category = EXCLUDED.calls_by_category,
  calls_by_province = EXCLUDED.calls_by_province,
  success_rate = EXCLUDED.success_rate,
  updated_at = now();

INSERT INTO app_users
  (id, name, phone, language, notifications, offline_mode, dark_mode)
VALUES
  (
